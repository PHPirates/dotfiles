...
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("brightnessctl -e4 -n0 set 5%+"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("brightnessctl -e4 -n0 set 5%-"), { locked = true, repeating = true })
...
hl.bind("mouse:275",  hl.dsp.send_shortcut({ mods = "CTRL", key = "W" }))
hl.bind("mouse_left", hl.dsp.focus({ workspace = "e-1" }))
hl.bind("mouse_right", hl.dsp.focus({ workspace = "e+1" }))

hl.bind("ALT + F3", hl.dsp.exec_cmd(programs.menu))
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd(programs.terminal .. " --class clipse -e 'clipse'"))
